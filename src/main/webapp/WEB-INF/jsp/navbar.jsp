...
<nav class="navbar navbar-default navbar-fixed-top" style="background-color: transparent; height: 100px;">
  <div class="container-fluid" id="navbarfluid" style="background-color: #400808ab; opacity: 0.8;">
    <div class="navbar-header">
      <a class="navbar-brand" href="index.jsp"><img src="https://www.steepconsult.com/sites/all/themes/dropsolid_theme/logo.png"
      style="opacity: 1;"></a>
    </div>
    <div id="myNavbar">
      <ul class="nav navbar-nav navbar-left">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="addScore/H.html">Group H</a></li>
            <li><a href="knockoutStage.html">Knockout Phase</a></li>
          </ul>
        </li>
